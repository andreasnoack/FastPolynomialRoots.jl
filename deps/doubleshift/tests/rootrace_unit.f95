...
program main 
  ...
  write (28,*) "% roots of unity"
  write (38,*) "% roots of unity"
  write (31,*) "% roots of unity"
  write (41,*) "% roots of unity"
  write (33,*) "% roots of unity"
  write (43,*) "% roots of unity"

  write (28,*) "\addplot coordinates{ % AMVW"
  write (38,*) "\addplot coordinates{ % AMVW"

  write (31,*) "\addplot coordinates{ % LAPACK"
  write (41,*) "\addplot coordinates{ % LAPACK"
